...
public class GoiHangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_goi_hang );
        initView();
        initControl();
        tinhTongTien();
    }
    ...
    private void initControl() {
        ...
        //kt neu gio hang trong thi cho hien textview gio hang trong
